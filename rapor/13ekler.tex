...
\begin{center}
  \url{https://github.com/bbasaranemir/SmartWalk}
\end{center}

Depoda ESP32 firmware, Python kaynak kodları ve örnek yapılandırma dosyaları yer almaktadır.

\section{Proje Web Sayfası (Deployment)}
\label{ek:deployment}

Projenin çalışır durum sayfasına aşağıdaki bağlantıdan erişilebilir:

\begin{center}
  \url{https://bbasaranemir.github.io/SmartWalk}
\end{center}

Sayfa; projenin mimarisini, canlı Telegram bildirim örneklerini ve sistem durumunu özetlemektedir.
